import { faCircleCheck, faStethoscope } from "@fortawesome/free-solid-svg-icons";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";

export const title = "Exames Físicos";

const sectionColor = "#dc2626";

const campos = [
  {
    titulo: "Inspeção Estática e Dinâmica",
    desc: "Avaliação postural, análise da marcha, assimetrias visíveis e padrões compensatórios.",
  },
  {
    titulo: "Palpação",
    desc: "Temperatura, consistência tecidual, tensão muscular, pontos dolorosos e sensibilidade regional.",
  },
  {
    titulo: "Testes Especiais e Ortopédicos",
    desc: "Manobras específicas para identificação e confirmação da hipótese diagnóstica.",
  },
  {
    titulo: "Amplitude de Movimento e Força Muscular",
    desc: "Goniometria, medições funcionais, escala de força e dinamometria, com comparação bilateral.",
  },
  {
    titulo: "Sensibilidade e Propriocepção",
    desc: "Avaliação neurológica de sensibilidade superficial, profunda e controle proprioceptivo.",
  },
];

const orientacoes = [
  "Registre sempre valores quantitativos (graus, escalas, distâncias) para comparação evolutiva.",
  "Realize a comparação bilateral sempre que aplicável, documentando assimetrias encontradas.",
  "Utilize os testes especiais mais indicados para a condição clínica investigada.",
  "Os achados devem embasar e ser consistentes com o diagnóstico fisioterapêutico definido.",
  "Em caso de dor durante a avaliação, registre intensidade, localização e comportamento.",
];
...
export default function Slide7() {
  return (
    ...
    >
      ...
      <div data-object="true" data-object-type="shape" style={{ position: "absolute", left: "1300px", top: "-100px", width: "350px", height: "350px", borderRadius: "50%", backgroundColor: "#fee2e2", opacity: "0.4", zIndex: "0" }} />

      <div data-object="true" data-object-type="textbox" style={{ position: "absolute", left: "80px", top: "22px", zIndex: "10" }}>
        <span style={{ fontFamily: '"Open Sans", sans-serif', fontSize: "12px", fontWeight: "700", color: sectionColor, backgroundColor: "#fee2e2", padding: "3px 14px", borderRadius: "20px" }}>
          Preenchimento do Laudo — Seção 5 de 8
        </span>
      </div>
      ...
      <div data-object="true" data-object-type="textbox" style={{ position: "absolute", left: "80px", top: "128px", width: "820px", zIndex: "10" }}>
        <p style={{ fontFamily: '"Open Sans", sans-serif', fontSize: "18px", color: "#4a5568", margin: "0", lineHeight: "1.6" }}>
          Documentação sistemática dos achados da avaliação clínica, fornecendo dados objetivos para sustentar o diagnóstico e monitorar a evolução do paciente.
        </p>
      </div>
      ...
      <div data-object="true" data-object-type="icon" style={{ position: "absolute", left: "100px", top: "226px", width: "40px", height: "40px", borderRadius: "50%", backgroundColor: sectionColor, display: "flex", alignItems: "center", justifyContent: "center", zIndex: "10" }}>
        <FontAwesomeIcon icon={faStethoscope} style={{ fontSize: "18px", color: "#ffffff" }} />
      </div>
      ...
      <div data-object="true" data-object-type="textbox" style={{ position: "absolute", left: "114px", top: "600px", width: "614px", zIndex: "10" }}>
        <p style={{ fontFamily: '"Open Sans", sans-serif', fontSize: "12px", color: "#92400e", lineHeight: "1.55", margin: "0" }}>
          <strong>Importante:</strong> A avaliação física objetiva serve como linha de base para o monitoramento evolutivo. Avaliações incompletas comprometem a evidência de progresso clínico.
        </p>
      </div>
      ...
      <img
        alt="Tela de exame físico — parte 1"
        data-object="true"
        data-object-type="image"
        src="/img/Estudante/Sistema_Alunos_atendimento_paciente_Acompanhamento_EFisico.png"
      ...
      />
      <img
        alt="Tela de exame físico — parte 2"
        data-object="true"
        data-object-type="image"
        src="/img/Estudante/Sistema_Alunos_atendimento_paciente_Acompanhamento_EFisico2.png"
