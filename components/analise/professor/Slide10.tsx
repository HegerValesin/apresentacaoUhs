...
const campos = [
  ...
  },
  {
    ...
    desc: "Professor responsável e equipe assistencial indicados para conduzir o próximo atendimento.",
  },
  {
    ...
    >
      ...
      <div data-object="true" data-object-type="textbox" style={{ position: "absolute", left: "80px", top: "128px", width: "820px", zIndex: "10" }}>
        <p style={{ fontFamily: '"Open Sans", sans-serif', fontSize: "18px", color: "#4a5568", margin: "0", lineHeight: "1.6" }}>
          Ao concluir a revisão clínica, o professor agenda o retorno do paciente para garantir continuidade terapêutica e alinhamento da supervisão.
        </p>
      </div>
